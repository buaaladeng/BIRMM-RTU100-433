...
typedef struct _NodeMsg
{
   ...
   // --------------------------------------------------------------------------
   // DESCRIPTION: 可选操作参数-A 传感器节点地址高字节
   // --------------------------------------------------------------------------
   unsigned char                                               m_iValueA;
      
   // --------------------------------------------------------------------------
   // DESCRIPTION: 可选操作参数-B  传感器节点地址低字节
   // --------------------------------------------------------------------------
...
//////////////////////433写各个参数函数/////////////////////////
void SetNodeSerialPort(u8 sBaudRate, u8 sVerifyType);   //设置433模块串口波特率和校验类型
